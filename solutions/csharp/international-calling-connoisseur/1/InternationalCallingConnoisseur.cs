public static class DialingCodes
{
    ...
    public static string GetCountryNameFromDictionary(
        ...
        existingDictionary.TryGetValue(countryCode, out var name) ? name : "";
    
    public static bool CheckCodeExists(Dictionary<int, string> existingDictionary, int countryCode) =>
        existingDictionary.TryGetValue(countryCode, out var name) ? true : false;
   
    public static Dictionary<int, string> UpdateDictionary(
        Dictionary<int, string> existingDictionary, int countryCode, string countryName)
    {
        if (existingDictionary.TryGetValue(countryCode, out var name))
    ...
    public static string FindLongestCountryName(Dictionary<int, string> existingDictionary)=>
     existingDictionary.Values.Aggregate("", (longest, current) =>
